...
\textbf{0.3977} (AUC = 0.6988), with Population Stability
...
Basel IRB Risk-Weighted Assets total \$21,592,289,075 at 228.8\% RWA density.
IFRS 9 Expected Credit Loss provisions total \$2,387,796,567 (coverage: 25.302\%).
\end{abstract}
...
& (0.6988 AUC) & Matches regulatory standards for acceptable discrimination. \\
OOT Separation (KS) & 0.2872 & Kolmogorov-Smirnov statistic; values above $\sim 0.30$ are typical for retail scorecards. \\
...
\texttt{grade\_enc} & -0.5388 & 0.0105 & -51.266 & 0.0000$^{***}$ \\
\texttt{term\_enc} & -0.6364 & 0.0125 & -50.855 & 0.0000$^{***}$ \\
\texttt{loan\_to\_income} & -0.4237 & 0.0158 & -26.897 & 0.0000$^{***}$ \\
\texttt{fico\_range\_high} & -0.2744 & 0.0192 & -14.291 & 0.0000$^{***}$ \\
\texttt{revol\_util\_x\_open\_acc} & -0.1372 & 0.0235 & -5.841 & 0.0000$^{***}$ \\
\texttt{new\_accounts\_ratio} & -0.4344 & 0.0264 & -16.456 & 0.0000$^{***}$ \\
\texttt{dti} & -0.3090 & 0.0223 & -13.851 & 0.0000$^{***}$ \\
\texttt{bc\_open\_to\_buy} & -0.2275 & 0.0259 & -8.794 & 0.0000$^{***}$ \\
\texttt{num\_tl\_op\_past\_12m} & -0.1228 & 0.0296 & -4.141 & 0.0000$^{***}$ \\
\texttt{avg\_cur\_bal} & -0.3563 & 0.0315 & -11.306 & 0.0000$^{***}$ \\
\texttt{annual\_inc} & -0.5545 & 0.0321 & -17.250 & 0.0000$^{***}$ \\
\texttt{inq\_last\_6mths\_per\_month} & -0.5424 & 0.0305 & -17.810 & 0.0000$^{***}$ \\
\texttt{mths\_since\_recent\_bc} & -0.2482 & 0.0356 & -6.970 & 0.0000$^{***}$ \\
\texttt{num\_rev\_tl\_bal\_gt\_0} & -0.0781 & 0.0354 & -2.210 & 0.0271$^{**}$ \\
\texttt{mort\_acc} & -0.2170 & 0.0407 & -5.333 & 0.0000$^{***}$ \\
\midrule
...
\texttt{term\_enc} & (-inf, 48.00) & 0.3076 & -0.6364 & 270,363 & 13.16\% & 35.1 \\
\texttt{} & [48.00, inf) & -0.6604 & -0.6364 & 92,954 & 28.52\% & 17.3 \\
\texttt{} & Special & 0.0000 & -0.6364 & 0 & 0.00\% & 29.4 \\
\texttt{} & Missing & 0.0000 & -0.6364 & 0 & 0.00\% & 29.4 \\
\texttt{loan\_to\_income} & (-inf, 0.06) & 0.5537 & -0.4237 & 23,701 & 10.59\% & 36.2 \\
\texttt{} & [0.06, 0.10) & 0.4494 & -0.4237 & 31,272 & 11.62\% & 34.9 \\
\texttt{} & [0.10, 0.13) & 0.3716 & -0.4237 & 37,013 & 12.45\% & 34.0 \\
\texttt{} & [0.13, 0.16) & 0.2960 & -0.4237 & 30,065 & 13.29\% & 33.1 \\
\texttt{} & [0.16, 0.19) & 0.2007 & -0.4237 & 47,117 & 14.43\% & 31.9 \\
\texttt{} & [0.19, 0.25) & 0.0475 & -0.4237 & 59,488 & 16.43\% & 30.0 \\
\texttt{} & [0.25, 0.29) & -0.1475 & -0.4237 & 43,825 & 19.28\% & 27.6 \\
\texttt{} & [0.29, 0.35) & -0.3341 & -0.4237 & 38,671 & 22.36\% & 25.3 \\
\texttt{} & [0.35, 0.40) & -0.4938 & -0.4237 & 23,858 & 25.25\% & 23.4 \\
\texttt{} & [0.40, inf) & -0.5864 & -0.4237 & 28,307 & 27.04\% & 22.3 \\
\texttt{} & Special & 0.0000 & -0.4237 & 0 & 0.00\% & 29.4 \\
\texttt{} & Missing & 0.0000 & -0.4237 & 0 & 0.00\% & 29.4 \\
\texttt{fico\_range\_high} & (-inf, 666.50) & -0.3676 & -0.2744 & 29,804 & 22.94\% & 26.5 \\
\texttt{} & [666.50, 676.50) & -0.2966 & -0.2744 & 60,759 & 21.71\% & 27.1 \\
\bottomrule
...
\midrule
Model A (Full Scorecard) & Bureau + Application + int\_rate + grade & 0.6988 & 0.3977 \\
...
\midrule
Total Portfolio RWA & \$21,592,289,075 & \$7,077,949,899 \\
Minimum Capital Reserve (8\%) & \$1,727,383,126 & \$566,235,992 \\
Portfolio RWA Density & 228.8\% & 75.0\% \\
\bottomrule
\end{tabular}
\end{table}

The risk-sensitive IRB approach determines an RWA density of \textbf{228.8\%}. This risk-sensitive capital requirement demonstrates the value of developing internal risk models, indicating a necessary capital surcharge of \textbf{\$1,161,147,134} compared to the flat Standardised Approach, ensuring that the bank remains adequately capitalised against default stress in this retail portfolio.
...
\begin{table}[h]
    ...
    \begin{tabular}{lrrr}
        ...
        \midrule
        \textbf{Expected Loss (EL)} & \$2,316,616,242 & \$4,571,041,038 & 97.3\% \\
        \textbf{Risk-Weighted Assets (RWA)} & \$21,592,289,075 & \$21,039,974,576 & -2.6\% \\
        \textbf{Capital Requirement (8\%)} & \$1,727,383,126 & \$1,683,197,966 & -2.6\% \\
        \bottomrule
    \end{tabular}
\end{table}

Under the severe systematic stress shock ($Z = -2.0$), the portfolio's expected loss rises by 97.3\%, and the RWA expands by -2.6\%. This result feeds directly into capital adequacy planning (ICAAP).
...
\midrule
Expected Loss (EL) & 2,317.66 \\
Value-at-Risk (VaR 99.9\%) & 5,892.80 \\
Expected Shortfall (ES 99.9\%) & 6,183.94 \\
Unexpected Loss (UL $=$ VaR $-$ EL) & 3,575.14 \\
\midrule
\textbf{Economic Capital (EC $=$ ES $-$ EL)} & \textbf{3,866.28} \\
Basel IRB Regulatory Capital (8\%) & 1,727.38 \\
EC / Regulatory Capital & 223.8\% \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
\multicolumn{5}{l}{\textbf{Granularity Adjustment (capital surcharge):} \$965} \\
\midrule
...
Model validation is performed on the completely held-out Out-of-Time (OOT) dataset ($2016$--$2018$). The PD scorecard shows stable performance with an OOT AUC of \textbf{0.6988} and a Kolmogorov-Smirnov (KS) statistic of \textbf{0.2872}.
...
Calibration was evaluated by comparing predicted default rates against actual observed default rates across risk deciles. The Hosmer-Lemeshow test \parencite{hosmer2013} rejects perfect calibration on the OOT dataset ($p = \text{\textbf{0.0000}} < 0.05$). Given the very large sample size ($N = \text{538,515}$), this result partly reflects the high sensitivity of the chi-squared goodness-of-fit test, but the calibration plots also indicate systematic underprediction at higher risk deciles. Recalibration is governed by an out-of-time gate. The OOT window is split chronologically: the earlier 269,258 loans form the fitting slice and the later 269,257 the evaluation slice. The gate \emph{triggers} on evidence of miscalibration in the fitting slice, \emph{fits} the candidate transform on that slice only, and \emph{accepts} it solely if it demonstrably improves calibration on the evaluation slice, which is never used for fitting. Gating on the in-time partition instead would be blind to the very era drift documented in Section~7.3 --- that test passes comfortably --- while fitting on the evaluation slice would trivially pass Hosmer-Lemeshow as an in-sample artefact. This design avoids both failure modes. On this run the gate \emph{triggered} (Hosmer-Lemeshow rejects on the fitting slice (p=0.0000); aggregate predicted/actual ratio 0.693 outside +/-10\%), selected an \emph{isotonic} transform by out-of-fold Brier score computed within the fitting slice, and \emph{accepted} it. On the held-out later slice the predicted-to-actual ratio moves from 0.690 to 0.998, the calibration intercept from 0.5365 to 0.0120, and the Brier score from 0.1800 to 0.1727. The transform \emph{is} attached to the production scorecard, so the PDs feeding Expected Loss, Basel RWA and IFRS~9 staging are recalibrated. Because every one of those improvements is measured on vintages excluded from the fit, this is an out-of-sample result rather than an in-sample artefact. Note that the IFRS 9 lifetime PD is produced by the separate hazard model and is not passed through this transform (Section~6.2), so the ECL provisions do not inherit the correction; the known limitations in Section~10 still apply.
...
\midrule
OOT AUC & --- & 0.6988 & 0.6985 & -0.0003 \\
Brier Score & $<0.25$ & 0.1784 & 0.1798 & +0.0015 $\times$ \\
Calibration Slope & $\approx 1.00$ & 1.0102 & 0.9803 & -0.0299 $\times$ \\
Calibration Intercept & $\approx 0.00$ & 0.5272 & 0.5397 & +0.0125 $\times$ \\
...
\bottomrule
\multicolumn{5}{p{\linewidth}}{\footnotesize \checkmark\ marks a metric that moved \emph{toward} its target and $\times$ one that moved away. This table is a fixed diagnostic, not the production gate: isotonic regression fitted on the in time test partition and applied (transform only) to the whole OOT set. The production recalibration decision is made by the out-of-time gate described above, which fits inside the OOT window and validates on a disjoint later slice of it.} \\
\end{tabular}
\end{table}
...
\midrule
2007Q2 & 24 & 14.52\% & 12.50\% [4.3\%, 31.0\%] & 1.16 {\checkmark} \\
2007Q3 & 190 & 21.19\% & 21.05\% [15.9\%, 27.4\%] & 1.01 {\checkmark} \\
2007Q4 & 389 & 24.37\% & 29.56\% [25.2\%, 34.3\%] & 0.82 {\checkmark} \\
2008Q1 & 1,013 & 21.75\% & 23.10\% [20.6\%, 25.8\%] & 0.94 {\checkmark} \\
2008Q2 & 498 & 20.00\% & 22.09\% [18.7\%, 25.9\%] & 0.91 {\checkmark} \\
2008Q3 & 298 & 20.50\% & 17.45\% [13.6\%, 22.2\%] & 1.17 {\checkmark} \\
2008Q4 & 584 & 17.08\% & 17.12\% [14.3\%, 20.4\%] & 1.00 {\checkmark} \\
2009Q1 & 895 & 18.41\% & 13.74\% [11.6\%, 16.2\%] & 1.34 {\checkmark} \\
2009Q2 & 1,098 & 16.64\% & 14.39\% [12.4\%, 16.6\%] & 1.16 {\checkmark} \\
2009Q3 & 1,364 & 16.04\% & 12.76\% [11.1\%, 14.6\%] & 1.26 {\checkmark} \\
2009Q4 & 1,924 & 16.62\% & 13.93\% [12.5\%, 15.5\%] & 1.19 {\checkmark} \\
2010Q1 & 2,172 & 16.70\% & 11.69\% [10.4\%, 13.1\%] & 1.43 {\checkmark} \\
2010Q2 & 3,006 & 19.39\% & 14.67\% [13.5\%, 16.0\%] & 1.32 {\checkmark} \\
2010Q3 & 3,568 & 21.80\% & 15.05\% [13.9\%, 16.3\%] & 1.45 {\checkmark} \\
2010Q4 & 3,791 & 20.46\% & 13.85\% [12.8\%, 15.0\%] & 1.48 {\checkmark} \\
2011Q1 & 4,126 & 20.59\% & 13.69\% [12.7\%, 14.8\%] & 1.50 $\dagger$ \\
2011Q2 & 5,102 & 20.87\% & 15.35\% [14.4\%, 16.4\%] & 1.36 {\checkmark} \\
2011Q3 & 5,876 & 19.51\% & 14.65\% [13.8\%, 15.6\%] & 1.33 {\checkmark} \\
2011Q4 & 6,617 & 20.86\% & 16.44\% [15.6\%, 17.4\%] & 1.27 {\checkmark} \\
2012Q1 & 8,076 & 19.08\% & 16.15\% [15.4\%, 17.0\%] & 1.18 {\checkmark} \\
2012Q2 & 10,447 & 22.39\% & 17.03\% [16.3\%, 17.8\%] & 1.31 {\checkmark} \\
2012Q3 & 16,133 & 23.94\% & 16.45\% [15.9\%, 17.0\%] & 1.46 {\checkmark} \\
2012Q4 & 18,711 & 24.96\% & 15.54\% [15.0\%, 16.1\%] & 1.61 $\dagger$ \\
2013Q1 & 22,706 & 25.26\% & 15.02\% [14.6\%, 15.5\%] & 1.68 $\dagger$ \\
2013Q2 & 30,668 & 26.58\% & 16.25\% [15.8\%, 16.7\%] & 1.64 $\dagger$ \\
2013Q3 & 37,571 & 26.52\% & 15.56\% [15.2\%, 15.9\%] & 1.70 $\dagger$ \\
2013Q4 & 43,862 & 26.06\% & 15.47\% [15.1\%, 15.8\%] & 1.68 $\dagger$ \\
2014Q1 & 47,049 & 26.89\% & 16.55\% [16.2\%, 16.9\%] & 1.62 $\dagger$ \\
2014Q2 & 52,528 & 27.22\% & 18.73\% [18.4\%, 19.1\%] & 1.45 {\checkmark} \\
2014Q3 & 55,327 & 27.21\% & 18.94\% [18.6\%, 19.3\%] & 1.44 {\checkmark} \\
2014Q4 & 68,533 & 26.85\% & 19.54\% [19.2\%, 19.8\%] & 1.37 {\checkmark} \\
2016Q1 & 112,966 & 24.70\% & 21.09\% [20.9\%, 21.3\%] & 1.17 {\checkmark} \\
2016Q2 & 63,851 & 25.03\% & 26.40\% [26.1\%, 26.7\%] & 0.95 {\checkmark} \\
2016Q3 & 62,074 & 26.27\% & 27.37\% [27.0\%, 27.7\%] & 0.96 {\checkmark} \\
2016Q4 & 58,760 & 25.71\% & 25.75\% [25.4\%, 26.1\%] & 1.00 {\checkmark} \\
2017Q1 & 48,333 & 25.25\% & 25.26\% [24.9\%, 25.7\%] & 1.00 {\checkmark} \\
2017Q2 & 46,274 & 25.39\% & 26.74\% [26.3\%, 27.1\%] & 0.95 {\checkmark} \\
2017Q3 & 46,261 & 25.91\% & 27.90\% [27.5\%, 28.3\%] & 0.93 {\checkmark} \\
2017Q4 & 36,457 & 25.02\% & 26.57\% [26.1\%, 27.0\%] & 0.94 {\checkmark} \\
2018Q1 & 24,682 & 24.60\% & 26.49\% [25.9\%, 27.0\%] & 0.93 {\checkmark} \\
2018Q2 & 20,929 & 24.74\% & 27.84\% [27.2\%, 28.5\%] & 0.89 {\checkmark} \\
2018Q3 & 12,049 & 24.30\% & 22.89\% [22.1\%, 23.6\%] & 1.06 {\checkmark} \\
2018Q4 & 5,879 & 23.38\% & 16.52\% [15.6\%, 17.5\%] & 1.42 {\checkmark} \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
2007-2012 & 95,902 & 21.75\% & 14.17\% & 14.25\% & 15.72\% & 1.384 \\
2013-2014 & 358,244 & 26.71\% & 17.87\% & 17.86\% & 17.45\% & 1.530 \\
2016-2018 & 538,515 & 25.24\% & 25.27\% & 25.28\% & 25.27\% & 0.999 \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
\textbf{Stage~1} & 326472 & 127324 & 76521 \\
\textbf{Stage~2} & 160866 & 164335 & 137143 \\
\textbf{Stage~3} & 0 & 0 & 0 \\
\bottomrule
...
Under the Basel Committee regulatory standards \parencite{bcbs2004,bcbs2017}, the risk-sensitive internal ratings-based (IRB) approach sets our Risk-Weighted Asset (RWA) density at \textbf{228.8\%}, above the flat 75\% risk weight assumed by the Standardised Approach (SA). Because this portfolio is a high-yield, higher-risk unsecured book, the risk-sensitive approach produces a capital \emph{surcharge} rather than relief, the expected outcome when portfolio risk exceeds the level implicit in the flat SA weight.

Consistent with the reject inference analysis of \textcite{crook2004reject}, the inclusion of parcelled rejected applications leads to a Gini shift of \textbf{\num{-0.0544}}. This shift is consistent with the presence of selection bias; through-the-door refitting produces a small, conservative change in the fitted parameters.
...
\midrule
PD AUC (OOT) & \textbf{\num{0.6988}} & $0.65 - 0.73$ & \textcite{lessmann2015benchmarking} & Within range &  \\
...
Reject Inference $\Delta$Gini & \textbf{\num{-0.0544}} & $0.00 - 0.10$ & \textcite{crook2004reject} & Below typical range & \\
...
\midrule
500 & 94.9\% & 20.01\% & \$-1,364,042,252 & \$1,967,892,487 & -85.96\% \\
\textbf{530} & \textbf{61.4\%} & \textbf{13.79\%} & \textbf{\$-527,448,663} & \textbf{\$763,379,420} & \textbf{-63.11\%} \\
540 & 43.7\% & 11.00\% & \$-294,970,919 & \$427,524,729 & -54.25\% \\
580 & 2.5\% & 3.01\% & \$-5,749,949 & \$7,462,118 & -22.86\% \\
...
IFRS~9 ECL Coverage  & 25.302\% & 40\% -- 45\%
